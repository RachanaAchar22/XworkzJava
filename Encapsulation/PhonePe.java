...
public class PhonePe {
	...
	public long getPhonepeNumber() {
		return this.phonepeNumber;
	}

	public void setPhonepeNumber(long phonepeNumber) {
	...
	public int getUpiNumber() {
		return this.upiNumber;
	}

	public void setUpiNumber(int upiNumber) {
